  ...
  fr: [
    ...
    },
    {
      ...
      steps: [
        ...
        "On enchérit à voix haute. Quand quelqu'un cède, on note sur le téléphone qui achète et à quel prix.",
        "L'acheteur paye : son budget baisse et la carte rejoint son équipe.",
        "Personne n'en veut ? Le piocheur garde la carte gratuitement !",
  ...
  en: [
    ...
    },
    {
      ...
      steps: [
        ...
        'Bid out loud: when someone gives in, enter on the phone who buys and for how much.',
        'The buyer pays — their budget goes down and the card joins their team.',
        'Nobody wants it? The drawer keeps the card for free!',
