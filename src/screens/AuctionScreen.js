...
const styles = StyleSheet.create({
  ...
  buyerBtn: { width: '100%', paddingVertical: 21, alignItems: 'center', borderRadius: 12, gap: 2 },
  ...
  nobodyBtn: { width: '80%', paddingVertical: 16, alignItems: 'center', borderRadius: 10, borderWidth: 1 },
  ...
  startAuctionBtn: { width: '100%', paddingVertical: 23, alignItems: 'center', borderRadius: 12 },
