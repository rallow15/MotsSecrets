...
const styles = StyleSheet.create({
  ...
  buyerBtn: { width: '100%', marginHorizontal: -10, paddingVertical: 21, alignItems: 'center', borderRadius: 12, gap: 2 },
  buyerBtnText: { fontFamily: 'BebasNeue', fontSize: 13, letterSpacing: 1, textAlign: 'center', color: '#F5F5DC' },
  buyerBtnSub: { fontFamily: 'SpaceMono', fontSize: 8, color: '#ff4444', letterSpacing: 1 },
  nobodyBtn: { width: '90%', marginHorizontal: -10, paddingVertical: 16, alignItems: 'center', borderRadius: 10, borderWidth: 1 },
  nobodyBtnText: { fontFamily: 'BebasNeue', fontSize: 13, letterSpacing: 1, textAlign: 'center' },
  ...
  startAuctionBtn: { width: '100%', marginHorizontal: -10, paddingVertical: 23, alignItems: 'center', borderRadius: 12 },
  startAuctionBtnText: { fontFamily: 'BebasNeue', fontSize: 14, color: '#F5F5DC', letterSpacing: 1, textAlign: 'center' },
