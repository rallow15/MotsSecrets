...
const LIEUX_IMAGES = {
  ...
  'Centre commercial': require('../../assets/lieux/41_Centre_commercial.png'),
  'Club de nuit': require('../../assets/lieux/42_Club_de_nuit.png'),
  'Montagne': require('../../assets/lieux/43_Montagne.png'),
  'Station de ski': require('../../assets/lieux/44_Station_de_ski.png'),
  'Zoo': require('../../assets/lieux/45_Zoo.png'),
  ...
  'Shopping Mall': require('../../assets/lieux/41_Centre_commercial.png'),
  'Nightclub': require('../../assets/lieux/42_Club_de_nuit.png'),
  'Mountain': require('../../assets/lieux/43_Montagne.png'),
  'Ski Resort': require('../../assets/lieux/44_Station_de_ski.png'),
  'Zoo': require('../../assets/lieux/45_Zoo.png'),
  'Restaurant': require('../../assets/lieux/02_Restaurant.png'),
  'Casino': require('../../assets/lieux/16_Casino.png'),
  'Prison': require('../../assets/lieux/18_Prison.png'),
